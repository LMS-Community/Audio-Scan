...
if tags may have been changed.  The hex MD5 value is returned in the &#36;info->{audio\_md5}
...
## find\_frame( &#36;path, &#36;timestamp\_in\_ms )
...
- WAV, AIFF, Musepack, Monkey's Audio, WavPack
    ...
    Not yet supported by find\_frame.

## find\_frame\_return\_info( &#36;path, &#36;timestamp\_in\_ms )
...
## find\_frame\_fh( &#36;type => &#36;fh, &#36;offset )

Same as `find_frame`, but with a filehandle.

## find\_frame\_fh\_return\_info( &#36;type => &#36;fh, &#36;offset )
...
embedded artwork.  To do this, set the environment variable AUDIO\_SCAN\_NO\_ARTWORK:
...
at [https://github.com/LMS-Community/slimserver-platforms/tree/public/8.5/readynas/contrib/scanner](https://github.com/LMS-Community/slimserver-platforms/tree/public/8.5/readynas/contrib/scanner)
...
ASF Spec [http://www.microsoft.com/windows/windowsmedia/forpros/format/asfspec.aspx](http://www.microsoft.com/windows/windowsmedia/forpros/format/asfspec.aspx)

MP4 Info:
[http://standards.iso.org/ittf/PubliclyAvailableStandards/c051533\_ISO\_IEC\_14496-12\_2008.zip](http://standards.iso.org/ittf/PubliclyAvailableStandards/c051533_ISO_IEC_14496-12_2008.zip)
...
Portable `stdint.h` originally copyright 2005-2007 Paul Hsieh.

See the `COPYING*` files in the distribution for more information.
